...
class Roulette:
    ...
    def __init__(self):
        ...
        self.win_screens = [pygame.image.load("assets/screens/win.png"),
        ...
        self.ambient_music = pygame.mixer.music.load(random.choice(["assets/sounds/ambient.mp3", "assets/sounds/ambient2.mp3"]))
        pygame.mixer.music.play()
        pygame.mixer.music.set_volume(0.2)

        self.place_bet_sounds = [pygame.mixer.Sound("assets/sounds/place1.mp3"),
        ...
        self.place_bets_please_sounds = [pygame.mixer.Sound("assets/sounds/please1.mp3"),
        ...
        self.ball_bounce_sounds = [pygame.mixer.Sound("assets/sounds/bounce.mp3"),
    ...
    def processPhysics(self, now: int):
        ...
        if self.ball_rotation_speed != 0:
            if self.ball_distance <= 76.0: # Wait for the ball to fall towards the wheel
                ...
                if now - self.ball_bounce_timestamp > random.randrange(200, 400) and self.ball_num_bounces < 3 and abs(self.ball_rotation_speed - self.wheel_rotation_speed) > 0.01:
    ...
    def renderTable(self, now: int):
        ...
        self.screen.blit(self.ball_png, [wheel_center[0] - 7 + self.ball_distance * math.cos(self.ball_rotation_angle),
            ...
            if self.quit_counter > 0:
                ...
                if self.bank_account == 0: # Is the game over?
                    if self.game_over_timestamp == 0:
                        self.game_over_timestamp = now + 2000 # We add 2000 so that it waits 2 seconds before starting to show the end screen
